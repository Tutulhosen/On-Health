...
<p style="font-size: 45px; color:red; background-color:blue" class="alert alert-warning"  >{{ $note}} <button style=" color:aliceblue" class="close " data-dismiss="alert" >&times;</button></p>
...
{{-- doctor team part  --}}
@include('frontend.layout.doctorTeam')
